...
def get_default_configs():
    ...
    data.path = Path("/media/khanhpham/새 볼륨/BRats2021") / dataset
    ...
    experiment_path = r"/home/khanhpham/diff_model/"
    ...
    score_model.attention_resolutions = "64,32,16,8"  # 16
    ...
    score_model.channel_mult = {64:(1, 2, 3, 4), 128:(1, 1, 2, 4, 8)}[score_model.image_size]
    ...
    config.fa = sampling = ml_collections.ConfigDict()
